...
class ProductFormPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // In this case, the form itself doesn't know how to save data because we're
    // not using a bloc for the form data (we could, and that's valid too).
    // We connect to the product list bloc here.
