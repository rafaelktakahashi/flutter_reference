...
> Note: My iOS project is currently broken because I don't have access to a recent version of Xcode anymore, as I'm on an older version of macOS. If you can fix the iOS project, feel free to do so.
...
You'll need to configure a Google Maps key to fully use this demo! If you do not, the app will likely crash due to not finding an API key.
